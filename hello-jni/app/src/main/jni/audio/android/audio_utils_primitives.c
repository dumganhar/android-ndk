 ...
 */
//cjh #include <cutils/bitops.h>  /* for popcount() */
...
//cjh void memcpy_by_channel_mask(void *dst, uint32_t dst_mask,
...
//cjh void memcpy_by_index_array(void *dst, uint32_t dst_channels,
