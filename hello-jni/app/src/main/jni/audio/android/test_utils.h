 ...
 */
class TestProvider : public cocos2d::AudioBufferProvider {
public:
    ...
    virtual cocos2d::status_t getNextBuffer(Buffer* buffer, int64_t pts __unused = kInvalidPTS)
    {
        ...
        if (buffer->frameCount > 0) {
            ...
            return cocos2d::NO_ERROR;
        } else {
            buffer->raw = NULL;
            return cocos2d::NOT_ENOUGH_DATA;
        }
    }
